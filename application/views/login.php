    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="POST" action="<?= base_url('telegramBot'); ?>">
                    ...
                    <!-- <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" name="chat_id">
                        <span class="focus-input100" data-placeholder="Chat ID"></span>
                    </div>
                    <?php
                    ...
                    <div class="text-center p-t-50">
                        <div class="text-center">
                            <a class="small" href="<?= base_url('telegramBot/register'); ?>">Create an Account!</a>
                        </div>
                    </div>
                </form>
            </div>
