        ...
        <div class="col-lg-4 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Products Type</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div id="tabs2">
                        <ul>
                            <li><a href="#tabs2-1">Products Type</a></li>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        jQuery("#list3").jqGrid({
            url: '<?php echo base_url(); ?>productType/getProductType',
            datatype: "json",
            colModel: [{
            ...
            editurl: '<?php echo base_url(); ?>productType/crudProductType',
    ...
    function setDataDel() {
        ...
        var product_type_id = $('#list3').jqGrid('getCell', rowid, 'product_type_id');
        return data = {
            oper: 'del',
            product_type_id: product_type_id
        };
