        ...
        <div class="col-lg-4 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div id="tabs2">
                        <ul>
                            <li><a href="#tabs2-1">Products</a></li>
        ...
        jQuery("#list3").jqGrid({
            ...
            colModel: [{
                ...
                },
                {
                    ...
                    edittype: 'select',
                    editoptions: {
                        dataUrl: "<?php echo base_url(); ?>product/html_select_productType",
    ...
    $(document).ready(function() {
        $("#tabs2 ul li a").click(function(e) {
            if ($(this).attr("href") == "#tabs2-2") {
                ...
                var products_type_id = grid.jqGrid('getCell', idpsn, 'products_type_id');
                var name_prod = grid.jqGrid('getCell', idpsn, 'name_prod');
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= base_url(); ?>detailTab/detailProduct",
