                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="<?= base_url('auth/registration'); ?>">
                            <div class="form-group">
                                ...
                                <?= form_error('fullname', '<small class="text-danger p-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" class="form-control form-control-user" name="passwordCon" id="exampleRepeatPassword" placeholder="Confirm Password">
                                    <?= form_error('passwordCon', '<small class="text-danger p-3">', '</small>'); ?>
                                </div>
                            </div>
